...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    Render.jumpWithHeightAndDuration(mySprite, 5, 500)
})
...
tiles.placeOnTile(coin, tiles.getTileLocation(11, 4))
tiles.placeOnTile(coin2, tiles.getTileLocation(7, 7))
tiles.placeOnTile(ghost2, tiles.getTileLocation(7, 9))
tiles.placeOnTile(ghost3, tiles.getTileLocation(15, 13))
